...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupButton(R.id.btn_hang_ngay, R.drawable.ic_hang_ngay, "Hàng ngày", v -> {
            Toast.makeText(MainActivity.this, "Chuyển đến màn hình Hàng ngày", Toast.LENGTH_SHORT).show();
            // TODO: Start Intent cho HangNgayActivity
        });
